 ...
 */
public class RawLogViewer extends JPanel {
     ...
     * 
     * @param logViewer
     * @return {@link JFrame} with {@link RawLogViewer} in contentPane
     */
    public static JFrame display( RawLogViewer logViewer ) {
        JFrame frame = new JFrame();
        frame.setTitle("Raw Logs");
